...
namespace TestCirclePawnWinform
{
    public class FitCircleHelper
    {
        ...
        /// <returns></returns>
        public double AngleBetweenXAxisAndPoint(PointD point, DrawCircle circleCenter)
        {
            double dx = point.X - circleCenter.CenterX;
            double dy = point.Y - circleCenter.CenterY;
